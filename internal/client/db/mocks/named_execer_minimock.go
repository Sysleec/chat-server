...
//go:generate minimock -i github.com/Sysleec/chat-server/internal/client/db.NamedExecer -o named_execer_minimock.go -n NamedExecerMock
...
import (
	...
	mm_db "github.com/Sysleec/chat-server/internal/client/db"
